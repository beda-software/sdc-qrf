...
export enum ExtensionIdentifier {
    ...
    TablePageSize = 'https://emr-core.beda.software/StructureDefinition/tablePageSize',
}
...
export const extensionTransformers: ExtensionTransformer = {
    ...
    [ExtensionIdentifier.TablePageSize]: {
        path: { extension: 'valueInteger', questionnaire: 'tablePageSize' },
    },
};
